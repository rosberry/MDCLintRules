 ...
 */
class MaterialToolbarDetector : ResourceXmlDetector(), SourceCodeScanner {

    override fun appliesTo(folderType: ResourceFolderType): Boolean = folderType == ResourceFolderType.LAYOUT

    override fun getApplicableElements(): Collection<String>? =
            listOf("androidx.appcompat.widget.Toolbar", "Toolbar")
    ...
    companion object {
        ...
        private val IMPLEMENTATION = Implementation(MaterialToolbarDetector::class.java, Scope.RESOURCE_FILE_SCOPE)

        val ISSUE: Issue = Issue
            .create(
                    id = "MaterialToolbarDetector",
                    briefDescription = "Use MDC Component",
                    explanation = "You should use MaterialToolbar".trimIndent(),
